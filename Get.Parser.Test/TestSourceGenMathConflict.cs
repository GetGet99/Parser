...
using System.Text;
using static TestSourceGenMathConflict.NonTerminal;
using static TestSourceGenMathConflict.Terminal;

[Parser(StartNode)]
// Comment out the line below to see the conflict shows up
[Precedence(Plus, Associativity.Left)]
partial class TestSourceGenMathConflict : ParserBase<TestSourceGenMathConflict.Terminal, TestSourceGenMathConflict.NonTerminal, decimal>
{
